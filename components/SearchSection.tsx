      ...
      >
        <div className="relative w-full md:flex-1" ref={wrapperRef}>
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-[var(--neutral-800)] border border-[var(--neutral-700)] rounded-lg shadow-xl z-50 overflow-hidden max-h-60 overflow-y-auto">
